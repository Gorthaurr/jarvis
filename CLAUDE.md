...
- **ВОЛНА E «что взяли у Skales» (2026-08-07; план/вердикты разбора — `docs/SKALES_ADOPTION_2026-08-07.md`;
  ...
  **КОНТРОЛЬ-3 (+1 HIGH, закрыт):** (17) 🔴 Windows 8.3 short-name обходил денилист — `MCP~1.JSO`
  ...
  Открыто из плана (следующие срезы): durable confirm-очередь (план 1.2), вкладка «Память» (1.3),
  мобильный пульт (1.1 — ждёт решения владельца по TG-боту), онбординг-инсталлер (1.4),
