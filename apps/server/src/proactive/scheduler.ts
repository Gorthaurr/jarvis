/**
 * ⚠️ МОДУЛЬ НЕ ПОДКЛЮЧЁН К РАНТАЙМУ (проверено grep-ом 2026-09-01: ни одного импорта из продакшн-кода).
 * Это задел проактивного слоя, а не работающий путь. Тесты на него намеренно УДАЛЕНЫ аудитом тестовой
 * базы: зелёный тест на неподключённом коде создаёт ложное ощущение покрытия — «проверено» там, где
 * проверять в рантайме нечего. Подключишь к делу — пиши тесты вместе с проводкой, против реального
 * механизма, а не против чистых функций (урок аудита: дыры живут именно в проводке).
 */
/**
